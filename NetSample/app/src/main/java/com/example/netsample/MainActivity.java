...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private static final String CAT_URL = "https://demo1155324.mockable.io/cat";
    private static final String DOG_URL = "https://demo1155324.mockable.io/dog";
    ...
    private void loadHorseAsync() {
        Retrofit retrofit = new Retrofit
                ...
                .baseUrl("https://demo1155324.mockable.io")
                .build();
